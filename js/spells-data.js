...
const SPELLS = [
  ...
  { name:'Guidance',         level:'cantrip', school:'Divination',   cast:'1 action',  range:'Touch',  duration:'1 min',   desc:'Touch a willing creature. Once before the spell ends, they can add 1d4 to one ability check.' },
  ...
  { name:'Hex',              level:'1', school:'Enchantment',  cast:'Bonus',     range:'90 ft',        duration:'1 hr',    desc:'Curse a creature. Deal extra 1d6 necrotic on each hit. Choose an ability; creature has disadvantage on that ability\'s checks.' },
  { name:'Bless',            level:'1', school:'Enchantment',  cast:'1 action',  range:'30 ft',        duration:'1 min',   desc:'Up to 3 creatures add 1d4 to attack rolls and saving throws. Concentration. +1 creature per slot above 1st.' },
  ...
  { name:'Detect Magic',     level:'1', school:'Divination',   cast:'1 action',  range:'Self',         duration:'10 min',  desc:'Sense the presence of magic within 30 ft. You can see a faint aura around magical creatures or objects, and learn their school of magic.' },
  ...
  { name:'Faerie Fire',      level:'1', school:'Evocation',    cast:'1 action',  range:'60 ft',        duration:'1 min',   desc:'DEX save or outlined in blue, green, or violet light. Attacks against affected creatures have advantage. No hiding while lit.' },
  { name:'Entangle',         level:'1', school:'Conjuration',  cast:'1 action',  range:'90 ft',        duration:'1 min',   desc:'Grasping weeds and vines sprout in a 20-ft square. STR save or restrained. Difficult terrain for all. Concentration.' },
  ...
  { name:'Hold Person',      level:'2', school:'Enchantment',  cast:'1 action',  range:'60 ft',  duration:'1 min',   desc:'WIS save or a humanoid is paralyzed. Attacks against them have advantage and hits within 5ft are critical. Repeats save each turn.' },
  { name:'Invisibility',     level:'2', school:'Illusion',     cast:'1 action',  range:'Touch',  duration:'1 hr',    desc:'A creature becomes invisible until it attacks or casts a spell. +1 creature per slot above 2nd. Concentration.' },
  { name:'Suggestion',       level:'2', school:'Enchantment',  cast:'1 action',  range:'30 ft',  duration:'8 hrs',   desc:'WIS save or a creature follows a suggested course of action (1-2 sentences). Must be reasonable. Concentration.' },
  ...
  { name:'Web',              level:'2', school:'Conjuration',  cast:'1 action',  range:'60 ft',  duration:'1 hr',    desc:'Fill a 20-ft cube with thick webbing. DEX save or restrained. Webs are flammable. Concentration.' },
  { name:'Darkness',         level:'2', school:'Evocation',    cast:'1 action',  range:'60 ft',  duration:'10 min',  desc:'Magical darkness spreads from a point. Even darkvision can\'t see through it. Concentration.' },
  ...
  { name:'Hypnotic Pattern', level:'3', school:'Illusion',     cast:'1 action',  range:'120 ft',       duration:'1 min',   desc:'A twisting pattern of colors weaves through the air. WIS save or charmed and incapacitated. Any damage ends the effect on that creature. Concentration.' },
  { name:'Fear',             level:'3', school:'Illusion',     cast:'1 action',  range:'Self (30ft cone)', duration:'1 min', desc:'Creatures in a 30-ft cone must make WIS save or become frightened and drop held objects. Must use movement to flee. Concentration.' },
  { name:'Fly',              level:'3', school:'Transmutation',cast:'1 action',  range:'Touch',        duration:'10 min',  desc:'A willing creature gains a flying speed of 60 ft. Concentration. +1 target per slot above 3rd.' },
  ...
  { name:'Spirit Guardians', level:'3', school:'Conjuration',  cast:'1 action',  range:'Self',         duration:'10 min',  desc:'Spirits protect you in a 15-ft radius. WIS save or half speed; 3d8 radiant/necrotic damage to hostile creatures entering. Concentration.' },
  ...
  { name:'Haste',            level:'3', school:'Transmutation',cast:'1 action',  range:'30 ft',        duration:'1 min',   desc:'A willing creature has doubled speed, +2 AC, advantage on DEX saves, and an extra action each turn (limited actions). Concentration. Lethargy after.' },

  // ---- Level 4 ----
  { name:'Banishment',          level:'4', school:'Abjuration',   cast:'1 action', range:'60 ft',  duration:'1 min',  desc:'CHA save or creature is banished to a demi-plane. If native to current plane, returns when concentration ends. If not, stays permanently.' },
  { name:'Polymorph',           level:'4', school:'Transmutation',cast:'1 action', range:'60 ft',  duration:'1 hr',   desc:'WIS save or creature transforms into a beast. Uses beast\'s stats; reverts when at 0 HP (excess damage carries over). Concentration.' },
  { name:'Greater Invisibility',level:'4', school:'Illusion',     cast:'1 action', range:'Touch',  duration:'1 min',  desc:'Target creature is invisible — even while attacking or casting spells. Attacks while invisible have advantage; attacks against have disadvantage. Concentration.' },
  { name:'Wall of Fire',        level:'4', school:'Evocation',    cast:'1 action', range:'120 ft', duration:'1 min',  desc:'Create a wall of fire up to 60ft long. DEX save: 5d8 fire on fail (half on success) when entering or starting turn there. Concentration.' },
  { name:'Confusion',           level:'4', school:'Enchantment',  cast:'1 action', range:'90 ft',  duration:'1 min',  desc:'WIS save or creatures in a 10-ft radius act randomly each turn — wander, do nothing, attack nearest. Concentration.' },
  ...
  { name:'Hold Monster',     level:'5', school:'Enchantment',  cast:'1 action', range:'90 ft',  duration:'1 min',   desc:'WIS save or any creature (not just humanoid) is paralyzed. Attacks within 5ft are critical hits. Repeats save each turn. Concentration.' },
  { name:'Wall of Force',    level:'5', school:'Evocation',    cast:'1 action', range:'120 ft', duration:'10 min',  desc:'Create an invisible, indestructible wall of force. Nothing can pass through or teleport through it. Concentration.' },
  { name:'Dominate Person',  level:'5', school:'Enchantment',  cast:'1 action', range:'60 ft',  duration:'1 min',   desc:'WIS save or a humanoid is charmed by you. You have a telepathic link and can command them on your turn. Concentration.' },
  ...
  { name:'Bigby\'s Hand',    level:'5', school:'Evocation',    cast:'1 action', range:'120 ft', duration:'1 min',   desc:'Create a Large hand of shimmering force. Can clenched fist (4d8 force), forceful hand (push), grasping hand (restrain), interposing hand (block). Concentration.' },
];